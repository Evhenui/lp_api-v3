  ...
  <section class="privacy-policy">
    <div class="privacy-policy__w">
      ...
      <ol class="privacy-policy__info">
        ...
        <li class="privacy-policy__text">
          <span class="privacy-policy__entepreneur">{{ _T('@FLP Privacy Policy') }}</span>
        ...
        <li class="privacy-policy__text">
          ...
          <ol class="privacy-policy__info">
            ...
            <li class="privacy-policy__text">
              ...
              <a href="#" class="privacy-policy__link">Logicpower.ua</a>, {{ _T('@Privacy policy p4.10-3') }} <a
                href="#" class="privacy-policy__link">Logicpower.ua</a>
        ...
        <li class="privacy-policy__text">
          {{ _T('@Privacy Policy p5-1') }} <a href="#" class="privacy-policy__link">Logicpower.ua</a> {{
            _T('@Privacy policy p5- 2')
          }} {{ _T('@FLP Privacy Policy') }}. {{ _T('@Privacy policy p5-3') }}
        </li>
        <li class="privacy-policy__text">
        ...
        <li class="privacy-policy__text">
          ...
          <a href="#" class="privacy-policy__link">Logicpower.ua</a> {{ _T('@Privacy Policy p7-3') }} {{
            _T('@FLP Privacy Policy')
          }} {{ _T('@Privacy Policy p7-4') }}
        </li>
        <li class="privacy-policy__text">
          <span class="privacy-policy__entepreneur">{{ _T('@FLP Privacy Policy') }}</span>
        ...
        <li class="privacy-policy__text">
          {{ _T('@Privacy policy p11-1') }} <a href="#" class="privacy-policy__link">Logicpower.ua</a>, {{
            _T('@Privacy policy p11- 2')
          }}
          <span class="privacy-policy__entepreneur">{{ _T('@FLP Privacy Policy') }}</span>
          {{ _T('@Privacy policy p11-3') }} <a href="#" class="privacy-policy__link">Logicpower.ua</a>, {{
            _T('@Privacy policy p11- 4')
          }}
        </li>
        <li class="privacy-policy__text">
        ...
        <li class="privacy-policy__text">
          ...
          <a href="#" class="privacy-policy__link">Logicpower.ua</a>{{ _T('@Privacy policy p13-2') }} {{
            _T('@FLP Privacy Policy')
          }}.{{ _T('@Privacy policy p13-3') }}
          <a href="#" class="privacy-policy__link">Logicpower.ua</a>.
        </li>
        <li class="privacy-policy__text">
        ...
        <li class="privacy-policy__text">
          ...
          <a href="#" class="privacy-policy__link">Logicpower.ua</a>, {{ _T('@Privacy policy p16-2') }} {{
            _T('@FLP Privacy Policy')
          }} {{ _T('@Privacy policy p16-3') }}
        </li>
        <li class="privacy-policy__text">
